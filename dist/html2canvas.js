...
var _fontVariantLigatures = __webpack_require__(18);
...
var inlineListItemElement = exports.inlineListItemElement = function inlineListItemElement(node, container, resourceLoader) {
    ...
    if (text) {
        ...
        // $FlowFixMe
        container.childNodes.push(new _NodeContainer2.default(wrapper, container, resourceLoader, 0, container.options));
    }
};
...
var FONT_VARIANT_LIGATURES = exports.FONT_VARIANT_LIGATURES = {
    NORMAL: 'normal',
    NONE: 'none',
...
var parseFontVariantLigatures = exports.parseFontVariantLigatures = function parseFontVariantLigatures(fontVariantLigatures) {
...
var Renderer = function () {
    ...
    _createClass(Renderer, [{
        ...
        value: function renderNode(container) {
            if (this.options.ignoreRendering && this.options.ignoreRendering(container, this.target, this.options)) {
                return;
            }
            if (container.isVisible()) {
